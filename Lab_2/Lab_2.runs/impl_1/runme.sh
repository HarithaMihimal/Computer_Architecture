...
HD_PWD='C:/Users/Isara Liyanage/Lab_2/Lab_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab_2.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Lab_2.tcl -notrace
